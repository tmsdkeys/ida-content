...
func (m *IbcTopRankPacketData) GetRank() string {
	if m != nil {
		return m.Rank
	}
	return ""
...
func (m *IbcTopRankPacketData) GetScore() string {
	if m != nil {
		return m.Score
	}
	return ""
...
func init() {
	proto.RegisterType((*LeaderboardPacketData)(nil), "tmsdkeys.leaderboard.leaderboard.LeaderboardPacketData")
	proto.RegisterType((*NoData)(nil), "tmsdkeys.leaderboard.leaderboard.NoData")
	proto.RegisterType((*IbcTopRankPacketData)(nil), "tmsdkeys.leaderboard.leaderboard.IbcTopRankPacketData")
	proto.RegisterType((*IbcTopRankPacketAck)(nil), "tmsdkeys.leaderboard.leaderboard.IbcTopRankPacketAck")
}
...
var fileDescriptor_be3d647100ade211 = []byte{
	...
	,
	...
	0xf9, 0xb9, 0xfa, 0xb0, 0x40, 0xd1, 0x47, 0x8e, 0xd2, 0x0a, 0x14, 0x5e, 0x49, 0x65, 0x41, 0x6a,
	0x71, 0x12, 0x1b, 0x38, 0x82, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x8f, 0xf4, 0x85, 0xaa,
	0xfc, 0x01, 0x00, 0x00,
}
...
func (m *IbcTopRankPacketData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Score) > 0 {
		i -= len(m.Score)
		copy(dAtA[i:], m.Score)
		i = encodeVarintPacket(dAtA, i, uint64(len(m.Score)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Rank) > 0 {
		i -= len(m.Rank)
		copy(dAtA[i:], m.Rank)
		i = encodeVarintPacket(dAtA, i, uint64(len(m.Rank)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.PlayerId) > 0 {
